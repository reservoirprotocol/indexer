...
export class CollectionNormalized1669081936761 implements MigrationInterface {
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `

ALTER TABLE "collections" ADD COLUMN "normalized_floor_sell_id" TEXT;
ALTER TABLE "collections" ADD COLUMN "normalized_floor_sell_value" NUMERIC(78, 0);
ALTER TABLE "collections" ADD COLUMN "normalized_floor_sell_maker" BYTEA;
...
ALTER TABLE "collection_normalized_floor_sell_events"
  ADD CONSTRAINT "collection_normalized_floor_sell_events_pk"
  PRIMARY KEY ("id");
...
`
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "collections" DROP COLUMN "normalized_floor_sell_id";
ALTER TABLE "collections" DROP COLUMN "normalized_floor_sell_value";
