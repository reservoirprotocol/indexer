  ...
  public async getSequenceData(cursor: CursorInfo | null, limit: number) {
    ...
    if (result.length) {
      const data = result.map((r) => ({
        ...
        day0_volume_change: r.day0_volume_change,
        ...
        day0_floor_sale_value: r.day0_floor_sell_value ? r.day0_floor_sell_value.toString() : null,
        ...
        day30_floor_sale_value: r.day30_floor_sell_value
          ...
          : null,
        day0_floor_sale_change: r.day0_floor_sell_value
