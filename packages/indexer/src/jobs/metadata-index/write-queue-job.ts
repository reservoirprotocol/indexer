...
export type MetadataWriteQueueJobPayload = {
  collection: string;
  contract: string;
  tokenId: string;
  name?: string;
...
export class MetadataWriteQueueJob extends AbstractRabbitMqJobHandler {
  ...
  protected async process(payload: MetadataWriteQueueJobPayload) {
  ...
  public async addToQueue(params: MetadataWriteQueueJobPayload[]) {
...
export const metadataWriteQueueJob = new MetadataWriteQueueJob();
