...
ALTER TABLE transactions ADD COLUMN "contract_address" BYTEA NOT NULL DEFAULT E'\\\\x';
ALTER TABLE transactions ADD COLUMN "logs_bloom" BYTEA NOT NULL DEFAULT E'\\\\x';
