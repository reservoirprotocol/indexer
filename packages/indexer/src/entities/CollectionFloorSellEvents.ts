...
@Index(
  "collection_floor_sell_events_collection_id_created_at_id_index",
  ["collectionId", "createdAt", "id"],
  {}
)
@Index("collection_floor_sell_events_created_at_id_index", ["createdAt", "id"], {})
@Index("collection_floor_sell_events_pk", ["id"], { unique: true })
@Entity("collection_floor_sell_events", { schema: "public" })
export class CollectionFloorSellEvents {
