...
import { BaseBuildParams } from "@reservoir0x/sdk/dist/payment-processor-v2.0.1/builders/base";
...
export const getBuildInfo = async (
  ...
  const nonce = await paymentProcessorBase.getAndIncrementUserNonce(
  ...
  const buildParams: BaseBuildParams = {
    protocol:
      collectionResult.kind === "erc721"
        ? Sdk.PaymentProcessorV201.Types.OrderProtocols.ERC721_FILL_OR_KILL
    ...
    masterNonce: await commonHelpers.getMinNonce("payment-processor-v2.0.1", options.maker),
  };
