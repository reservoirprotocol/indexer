...
export type PaymentProcessorOrderKind = "payment-processor-v2.0.1";

export const offChainCheck = async (
  order: Sdk.PaymentProcessorBase.IOrder,
  orderKind: PaymentProcessorOrderKind,
  exchange: Sdk.PaymentProcessorBase.PaymentProcessorBaseExchange,
  options?: {
  ...
  if (
    ...
    ![
      Sdk.PaymentProcessorBase.Types.OrderProtocols.ERC1155_FILL_OR_KILL,
      Sdk.PaymentProcessorBase.Types.OrderProtocols.ERC1155_FILL_PARTIAL,
  ...
  if (
    ...
    ![Sdk.PaymentProcessorBase.Types.OrderProtocols.ERC721_FILL_OR_KILL].includes(
  ...
  if (options?.checkFilledOrCancelled) {
    ...
    if (
      order.params.protocol === Sdk.PaymentProcessorBase.Types.OrderProtocols.ERC1155_FILL_PARTIAL
    ) {
      try {
        // const exchange = new Sdk.PaymentProcessorBase.PaymentProcessorBaseExchangeExchange(config.chainId);
